...
const UserInfo = ( { setFormStateOnParent, initialUserData, initImageId } ) => {
 ...
 useEffect(()=> {
  ...
  const validateField = ( fieldName, value ) => {
    ...
    switch(fieldName) {
      ...
      case 'addressFirstLine':
          ...
          fieldValidationErrors.addressFirstLine = addressFirstLineValid ? '': ' is invalid  ';
    ...
    if( fieldName ) { newObject[fieldName] = value }
  ...
  const validateForm = (values) => {
    return ( !values.password || values.passwordValid ||  values.password === '' ) && values.stateValid && values.cityValid && values.addressFirstLineValid && values.sexValid && values.phoneNumberValid && values.lastNameValid && values.countryValid && values.zipCodeValid && values.dateValid && values.lastNameValid && values.firstNameValid && ( !imageId || imageId.length > 0 );                                                      
  }
      ...
      <div className='container personal_info personal_info_shadow_none'>
        ...
        <div className='row'>
          <div className='col-md-3 col-sm-12 mx-auto'>
                  ...
                  <CourseImageUpload operation={'edit'} setIdOnParent={ (id) => { setImageId(id); } } defaultImage={imageId} type={'PROFILE'}>  </CourseImageUpload>
                  </div>
            ...
            <form className='row mx-auto form_inputs'>
              ...
              <div className='col-lg-4 col-md-12 col-sm-12 inputs_group'>
                <div className='row last_name'>
                  ...
                  <FormControl variant="outlined" className='my_place_pass ps-2'>
              ...
              <div className='col-md-9 col-sm-12 inputs_group'>
                <div className='row address_optional'>
                  <label htmlFor='address'><a target="_blank" href="https://drala.io/">Drala Wallet Address (Optional):</a></label>
                  <input
                    type='text'
                    id='address'
                    name='address'
